...
export const DEFAULT_SCORE_FROM_TYPE: EffectWeightOpsFromType = {
	...
	[BotTurnEffectType.EliminateKnownValueUnusedType]: [43],
	[BotTurnEffectType.EliminateKnownValueUsedType]: [-10],
	[BotTurnEffectType.EliminateSetsUpExact]: [4],
	[BotTurnEffectType.EliminateStompsExact]: [-20],
	[BotTurnEffectType.EliminateUnknownValueUnusedType]: [16],
	[BotTurnEffectType.EliminateUnknownValueUsedType]: [-20],
